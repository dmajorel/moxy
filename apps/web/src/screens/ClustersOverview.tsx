...
export function ClustersOverview({
  ...
  return (
    <section className={classes}>
      ...
      {/*
        No empty state of its own. An overview with no cluster never reaches
        this component: App renders its EmptyView instead, and a second wording
        for the same situation is a message nobody can be shown and nobody
        maintains.
      */}
