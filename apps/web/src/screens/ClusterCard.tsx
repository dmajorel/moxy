 ...
 * the label read from `formatNodeStatus`, so a screen reader still hears
 * "Maintenance" on the row and a pointer still gets it as a tooltip.
 */
function MaintenanceMark() {
  const label = formatNodeStatus("maintenance");
  return (
    <IconTool
      size={14}
